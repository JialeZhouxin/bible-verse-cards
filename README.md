...
本应用已并入 [toolbox](https://github.com/JialeZhouxin/toolbox)
仓库的 `bible/` 目录，与心语卡牌、婚前辅导等工具一起，从一个工具箱首页进入。

**新地址：https://jialezhouxin.github.io/toolbox/bible/**
...
1. 打开 https://jialezhouxin.github.io/bible-verse-cards/ ，或直接双击 `index.html`。
2. 「今日经文」卡片上写下今天的感受。
